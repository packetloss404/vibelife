package com.packetcraft.paper.economy;
...
/**
 * Vault Economy implementation backed by the PacketCraft Fastify sidecar.
 *
 * All balance/transfer operations delegate to the sidecar REST API.
 * This allows any Vault-compatible plugin (ChestShop, etc.) to use PacketCraft currency.
 *
...
public class VaultProvider implements Economy {
    ...
    public VaultProvider(PacketCraftPlugin plugin) {
        this.plugin = plugin;
    }
