...
public class EventsScreen extends Screen {
    ...
    public EventsScreen() {
        super(Text.literal("VibeLife Events"));
    }
    ...
    private void fetchData() {
        dataLoaded = false;
        VibeLifeClient.getInstance().getSidecarApi().get("/api/events/upcoming?limit=20").thenAccept(resp -> {
            events.clear();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("\u00a76\u00a7lVibeLife Events"), centerX, 12, 0xFFFFFF);
