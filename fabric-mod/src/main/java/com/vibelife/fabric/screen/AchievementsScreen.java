...
public class AchievementsScreen extends Screen {
    ...
    public AchievementsScreen() {
        super(Text.literal("VibeLife Achievements"));
    }
    ...
    private void fetchLeaderboard() {
        VibeLifeClient.getInstance().getSidecarApi().get("/api/leaderboard?limit=10").thenAccept(resp -> {
            leaders.clear();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("\u00a76\u00a7lVibeLife Achievements"), centerX, 12, 0xFFFFFF);
